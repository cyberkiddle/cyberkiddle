...
I have added new module automation that can generate the php filter payload mainly for local file iclusion.
This automate the creation of multiple payloads and that can be grantfull Ethical hacker. 
